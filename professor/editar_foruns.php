...
<?php
    ...
    $idForum = base64_decode($_GET['idForum']);
?>
...
<?php }} ?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Edição de Fóruns</h1>
...
<?php 
            $i=1;  
            $foruns = mysqli_query($connect,"SELECT * FROM foruns WHERE id = '$idForum'");
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <form method="post">
                        ...
                        <input name="tema" type="text" class="form-control" aria-label="Large" aria-describedby="inputGroup-sizing-sm" value="<?php echo $tema;?>" readonly=“true”>
                        <strong>Detalhes: </strong>
                        <script src="https://cdn.ckeditor.com/4.14.0/full/ckeditor.js"></script>
                        <textarea name="detalhes"><?php echo $detalhes;?></textarea><hr>
                        <script>
                                CKEDITOR.replace( 'detalhes' );
                        </script>                           
                        <strong>Data de Entrega: </strong><input name="entrega" type="text" class="form-control" aria-label="Large" aria-describedby="inputGroup-sizing-sm" value="<?php echo $entrega;?>">  
                        <hr>
                        <div class="h7 mb-0 font-weight-bold text-gray-800"><FONT COLOR="#ff0000">A IMAGEM NÃO PODE SER ALTERADA</FONT></div>  
                        <button name="editar" type="submit" class="btn btn-warning">Editar Fórum</button>
                    </form>      
                    </div>
                  </div><br>
                </div>
...
<?php $i++; }}?>
 ...
 <?php
   if (isset($_POST['editar'])){     
       ...
       $inserir_forum_resposta = mysqli_query($connect,"UPDATE foruns SET detalhes = '$detalhes', data_entrega = '$dataX' WHERE id = '$id_forum'");
       
       echo "<script language='javascript'>window.alert('Seu Fórum foi atualizado!');</script>";
