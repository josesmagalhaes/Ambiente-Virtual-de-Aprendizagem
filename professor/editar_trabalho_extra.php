...
<?php }} ?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Faça as alterações necessárias do seu trabalho!</h1>
          </div>
...
mysqli_query($connect,"UPDATE trabalhos_extras SET disciplina = '$dis', tema = '$tema', detalhes = '$detalhes', data_entrega = '$encerramento', pontos = '$pontos' WHERE id = '$id' AND professor = '$code'");
    
    (move_uploaded_file($_FILES['trabalho']['tmp_name'], "../anexos/".$trabalho));
    

    echo "<script language='javascript'>window.alert('Trabalho editado com sucesso!');</script>";
    echo "<script language='javascript'>window.location='trabalhos_extras.php';</script>";

}?>

<?php
$sql_1 = mysqli_query($connect,"SELECT * FROM trabalhos_extras WHERE id = '$id'");
while($res_1 = mysqli_fetch_array($sql_1)){
?>
...
<table class="table table-bordered">
  ...
  <tr>
    <td><input class="form-control" disabled type="text" value="<?php echo $res_1['id'];?>"></td>
    <td><input class="form-control" disabled type="text" value="<?php echo $res_1['date'];?>"></td>
    <td>
	  ...
	  $sql_2 = mysqli_query($connect,"SELECT * FROM disciplinas WHERE professor = '$code' AND disciplina != '$dis'");
  ...
  <tr>
    <td><input class="form-control" type="text" name="pontos" value="<?php echo $res_1['pontos'];?>"></td>
    <td><input class="form-control" type="text" name="encerramento" value="<?php echo $res_1['data_entrega'];?>"></td>
    <td><input class="form-control" type="text" name="tema" value="<?php echo $res_1['tema'];?>"></td>
  </tr>
  <tr>
    <td colspan="3"><strong>Mais detalhes sobre o trabalho:</strong></td>
  </tr>
  <tr>
    <td colspan="3">
    <script src="https://cdn.ckeditor.com/4.14.0/full/ckeditor.js"></script>
                <textarea name="detalhes"><?php echo $res_1['detalhes'];?></textarea>
                <script>
  ...
  <tr>
    <td><strong>Anexo Enviado:</strong></td>
    <td><a href="../anexos/<?php echo $res_1['anexo'];?>" target="_blank"><?php echo $res_1['anexo'];?></a></td> 
    <td></td>  
  </tr>
  </table>
     <input class="btn btn-warning" type="submit" name="button" id="button" value="Editar">
  </form>
<?php } ?>  
</div>
