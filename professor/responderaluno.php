...
?>
        ...
        <div class="container-fluid">
          <!-- Page Heading -->
          <h1 class="h3 mb-1 text-gray-800">Responder Aluno</h1>
          <p class="mb-4">Neste espaço você pode responder seu aluno ou responsável pelo mesmo sobre algum trabalho, sugestão ou  algo mais que deseje comentar.</p>
            <form name="form_disc" method="post" action="">
          <div class="form-group">
            <label for="exampleFormControlTextarea1">Aluno:</label>
