...
<?php }} ?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-1 text-gray-800">Verificar Mensagens</h1>
          <p class="mb-4">Neste espaço, você pode verificar suas mensagens enviadas, bem como a situação das mesmas.</p>
          ...
          <div class="row">
                <table class="table table-bordered">
                  ...
                  <tbody>
            <?php
            $sql_1 = mysqli_query($connect,"SELECT * FROM central_mensagem WHERE emissor = '$code'");
            ...
            ?>                       
                    <tr>
                      ...
                      <td><?php echo $res_1['receptor'];?></td>
                      <td><?php echo $res_1['mensagem'];?></td>
