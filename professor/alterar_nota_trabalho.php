...
<?php }} ?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Alterar nota do trabalho do aluno</h1>
...
mysqli_query($connect,"UPDATE envio_de_trabalhos_extras SET nota = '$nota' WHERE id = '$id_envio' AND id_trabalho	 = '$id_trabalho' AND disciplina = '$disciplina' AND aluno = '$aluno'");

$sql_1 = mysqli_query($connect,"SELECT * FROM pontos_extras WHERE code = '$aluno' AND disciplina = '$disciplina'");
	while($res_1 = mysqli_fetch_array($sql_1)){
			$d_nota = $res_1['nota']-$a_nota;
			
			$nova_nota = $d_nota+$nota;
			
			mysqli_query($connect,"UPDATE pontos_extras SET nota = '$nova_nota' WHERE code = '$aluno' AND disciplina = '$disciplina'");
			
			
	
		}
    echo "<script language='javascript'>window.alert('Nota alterada com sucesso!');</script>";
    echo "<script language='javascript'>window.location='trabalhos_extras.php';</script>";

}?> 
 
<em>Digite qual será a nova nota: &nbsp;</em>
<form name="" method="post" action="" enctype="multipart/form-data">
 <input class="form-control" type="text" size="4" maxlength="7" name="nota" value="<?php echo $_GET['nota']; ?>" /><br><input class="btn btn-warning" type="submit" name="send" value="Alterar" />
</form> 
<?php } ?>
