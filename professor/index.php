...
<?php }} ?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Suas turmas</h1>
          ...
          <div class="row">
              <?php
              $sql_1 = mysqli_query($connect,"SELECT * FROM disciplinas WHERE professor = '$code'");
              ...
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><?php echo $res_1['curso'];?></div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $res_1['disciplina'];?></div>
                    </div>
                    <div class="col-auto">
                      <a class="a" href="notas.php?curso=<?php echo base64_encode($res_1['curso']); ?>&dis=<?php echo base64_encode($res_1['disciplina']); ?>"><i class="fas fa-table" title="Inserir Notas"></i></a>
                      <a class="a" href="notificacoes.php?curso=<?php echo base64_encode($res_1['curso']); ?>&dis=<?php echo base64_encode($res_1['disciplina']); ?>"><i class="far fa-bell" title="Notificar aluno"></i></a>
                      <a class="a" href="videoaulas.php?curso=<?php echo base64_encode($res_1['curso']); ?>&dis=<?php echo base64_encode($res_1['disciplina']); ?>"><i class="fas fa-video" title="Aula em vídeo"></i></a> 
                      <a class="a" href="enviar_arquivo.php?curso=<?php echo base64_encode($res_1['curso']); ?>&dis=<?php echo base64_encode($res_1['disciplina']); ?>&pg=envio_arquivos"><i class="far fa-file-pdf" title="Enviar arquivos"></i></a>
                      <a class="a" href="cadastrar_forum.php?curso=<?php echo base64_encode($res_1['curso']); ?>&dis=<?php echo base64_encode($res_1['disciplina']); ?>&code=<?php echo $code; ?>"><i class="fas fa-comment-dots" title="Cadastrar Fórum"></i></a>    
                    </div>
                  </div>
                </div>
              </div>
