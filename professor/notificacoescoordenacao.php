...
<?php }} ?>
        ...
        <div class="container-fluid">
          <!-- Page Heading -->
          <h1 class="h3 mb-1 text-gray-800">Notificar Coordenação</h1>
          <p class="mb-4">Neste espaço você pode notificar responsáveis pela coordenação da escola sobre algum trabalho, sugestão ou  algo mais que deseje comentar.</p>
