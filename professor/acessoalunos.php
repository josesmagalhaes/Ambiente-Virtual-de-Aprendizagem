 ...
 <?php
   ...
   ?>          
    ...
    <?php }}}}?>    
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-1 text-gray-800">Acessos</h1>
          <p class="mb-4">Neste espaço, você pode conferir os alunos que já acessarm a plataforma e suas respectivas datas.</p>
        <form method="post">
        <div class="form-group">
