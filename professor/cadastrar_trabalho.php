...
<?php }} ?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Cadastre abaixo as informações do trabalho!</h1>
...
$ext = strtolower(substr($_FILES['trabalho']['name'],-4));	
...
$sql_4 = mysqli_query($connect,"INSERT INTO trabalhos_extras (date, status, professor, curso, disciplina, tema, detalhes, anexo, data_entrega, pontos) VALUES ('$date', 'Ativo', '$code', '$curso', '$dis', '$tema', '$detalhes','$trabalho', '$encerramento', '$pontos')");

(move_uploaded_file($_FILES['trabalho']['tmp_name'], "../anexos/".$trabalho));

echo "<script language='javascript'>window.alert('Trabalho cadastrado com sucesso!');</script>";
...
<table class="table table-bordered">
  ...
  <tr>
    ...
    <td>
      ...
      <?php
      $sql_2 = mysqli_query($connect,"SELECT * FROM disciplinas WHERE professor = '$code'");
  ...
  <tr>
    <td><input class="form-control" type="text" name="pontos" value=""></td>
    <td><input class="form-control" type="text" name="encerramento" value=""></td>
    <td><input class="form-control" type="text" name="tema" value=""></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><strong>Anexar arquivo:</strong></td>
    <td><input type="file" name="trabalho" id="fileField"></td>
