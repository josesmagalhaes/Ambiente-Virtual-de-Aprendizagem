...
<?php }} ?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Aulas em vídeo : <?php echo $dis;?></h1>
            
          </div>
          <h4 class="h3 mb-0 text-gray-800">Playlists completas</h4>
          <!-- Content Row -->
          <div class="row">
<?php 
              ...
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <?php }else{
                    ?>    
                    <iframe width="240" height="240" src="https://www.youtube.com/embed/videoseries?list=<?php echo $live;?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe> 
                    <?php }?>    
                    </div>
                  </div>
                </div>
              ...
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <?php }else{
                    ?>    
                    <iframe width="240" height="240" src="https://www.youtube.com/embed/videoseries?list=<?php echo $live2;?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe> 
                    <?php }?>    
                    </div>
                  </div>
                </div>
...
<hr>
<h4 class="h3 mb-0 text-gray-800">Videoaulas únicas.</h4><br>            
            <div class="col-xl-12 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <?php }else{
                    ?>    
                    <iframe width="240" height="240" src="https://www.youtube.com/embed/<?php echo $live3;?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <?php }?>    
                    </div>
                  </div>
                </div>
              ...
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <?php }else{
                    ?>    
                    <iframe width="240" height="240" src="https://www.youtube.com/embed/<?php echo $live4;?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <?php }?>    
                    </div>
                  </div>
                </div>
