...
<?php }} ?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-1 text-gray-800">Suas Mensagens na Agenda</h1>
          <p class="mb-4">Neste espaço, você têm acesso a todas as suas mensagens na agenda!</p>
<?php 
            $quant_men = mysqli_query($connect,"SELECT serie FROM estudantes WHERE code = '$code'");
                if (mysqli_num_rows($quant_men)==''){
                            $turmaPegar = "";
...
?> 
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
            <?php
            $sql_1 = mysqli_query($connect,"SELECT * FROM central_agenda WHERE receptor = '$turmaPegar' ORDER BY `id` DESC");
            ...
            if (mysqli_num_rows($sqlCODENome)==''){
                ...
                <p class="text-xs"><?php echo "Situação: ".$res_1['status'];?></p> 
                 ...
                 <button type="submit" class="btn btn-success mb-2" name="marcarLida">Marcar como Lida</button> 
                </div>
              </div>
<?php }}?></form>
            </div>
...
<?php
    if (isset($_POST['marcarLida'])){
        ...
        $sql_4 = mysqli_query($connect,"UPDATE central_agenda SET status ='Lida' WHERE receptor = '$turmaPegar' and id='$id'");
