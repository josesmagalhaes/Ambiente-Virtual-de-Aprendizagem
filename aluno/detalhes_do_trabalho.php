...
<?php }} ?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-1 text-gray-800">Trabalhos a fazer | Detalhes</h1>
...
<table class="table table-bordered">
  ...
  <tr>
    <td><?php echo $res['data_entrega']; ?></td>
    <td><a href="../anexos/<?php echo $res['anexo']; ?>" target="_blank"><?php echo $res['anexo']; ?></a></td>
  </tr>
  <tr>
    <td colspan="2"><strong>Mais detalhes sobre o trabalho:</strong></td>
  </tr>
  <tr>
    <td colspan="2"><?php echo $res['detalhes']; ?></td>
  </tr>
  </table>
<?php } ?>  
</div><!-- box -->
