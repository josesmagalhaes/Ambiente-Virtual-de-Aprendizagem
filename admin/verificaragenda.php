...
<?php }} ?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-1 text-gray-800">Verificar Agendas</h1>
          <p class="mb-4">Neste espaço, você pode verificar suas agendas enviadas, bem como a situação das mesmas.</p>
          ...
          <div class="row">
                <table class="table table-bordered">
                  ...
                  <tbody>
            <?php
            $sql_1 = mysqli_query($connect,"SELECT * FROM central_agenda WHERE emissor = '$code'");
